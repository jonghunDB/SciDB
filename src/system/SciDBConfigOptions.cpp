...
void initConfig(int argc, char* argv[])
{
    ...
    cfg->addOption
        ...
        (CONFIG_HELP, 'h', "help", "", "", Config::BOOLEAN, "Show this text.",
                false, false)
//미리 sparse chunk에 대해 preallocating을 한다. default density of sparse chunk is 1%,
       ...
       120, false)
        ...
        (CONFIG_STRICT_CACHE_LIMIT, 0, "strict-cache-limit", "STRICT_CACHE_LIMIT", "", Config::BOOLEAN, "Block thread on cache overflow", false, false)
        ...
        (CONFIG_NEW_DBARRAY, 0, "new-db-array", "NEW_DBARRAY", "", Config::INTEGER,
         "Use new db array implementation.", 1, false)
        ...
        (CONFIG_STORAGE_LOG_ENABLE, 0, "storage-log-enable", "STORAGE_LOG_ENABLE", "", Config::BOOLEAN,
         "Write storage log, normally enabled", true, false)
        ...
        (CONFIG_MAX_ARENA_PAGE_SIZE, 0, "max-arena-page-size", "MAX_ARENA_PAGE_SIZE", "", Config::INTEGER, "Maximum arena page size in MiB", -1, false)
        (CONFIG_DATASTORE_PUNCH_HOLES, 0, "datastore-punch-holes", "DATASTORE_PUNCH_HOLES", "", Config::INTEGER,
                "Enable release of datastore blocks to filesystem during remove_versions()", 0, false)
        ;
