...
/**
 * @brief Quickly return a timestamp in seconds.
 *
 * @details Quickly get a timestamp from the clock with the lowest
 * call overhead.  Suitable for large-grained timing applications,
 * like reaping idle connections.
 */
inline time_t getCoarseTimestamp()
{
    timespec ts = {0, 0};
