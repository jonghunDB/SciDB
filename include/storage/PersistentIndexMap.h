...
public:
    ...
    public:
        ...
        PointerRange<char const> getAuxMeta() const
        {
            auto auxDataPtr = reinterpret_cast<char const*>(&_auxMetaData);
            return PointerRange<char const>(sizeof(ChunkAuxMeta), auxDataPtr);
        }
    ...
    public:
        ...
        PointerRange<const char> getAuxMeta() override;
         ...
         * Compare elements
         */
        bool operator==(const BaseIterator&) const override;
        bool operator!=(const BaseIterator&) const override;
    ...
    private:
        ...
        rocksdb::Iterator* _iter;  // ref to underlying rocksdb11 iterator
...
public:
    ...
    /**
     * @return iterator to the element following the last valid element (the _keyMax).
     */
    std::shared_ptr<BaseIterator> end() override;
    ...
    bool insert(Key const* key,
                ...
                PointerRange<const char> auxMeta) override;
    ...
    size_t size() const override
    {
        ...
        // TODO (bcarlson) Why does this always return 0?
        // My guess is that finding an exact count of key-value pairs in RocksDB is
        // non-trivial.
        return 0;
    }
...
private:
    ...
    public:
        /**
         * Static callback used to clear the db directory
         */
        static void clearDbCb(std::string dbPath, struct dirent* de);
        ...
        /**
         * Return a connection to the db which stores metadata for
         * array using the indicated datastore
         */
        rocksdb::DB* getDbConnection(const DataStore::DataStoreKey& _dsk);
    ...
    private:
        ...
        rocksdb::DB*               _dbConn;    // rocksdb11 connection
