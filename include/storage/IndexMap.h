...
public:
    ...
    public:
        ...
        virtual PointerRange<const char> getAuxMeta() = 0;
    ...
    virtual bool insert(Key const* key,
                        ...
                        PointerRange<const char> auxMeta) = 0;
...
protected:
    ...
    public:
        ...
        PointerRange<char> getAuxMeta() { return _auxMeta; }

        void update(BufferMgr::BufferHandle& value, PointerRange<char> auxMeta)
        {
            _value = value;
            _auxMeta = auxMeta;
        }
        ...
        ~BasicEntry()
        {
            ...
            if (_auxMeta.size()) {
                arena::destroy(*_arena, _auxMeta.begin());
            }
        }
    ...
    public:
        ...
        PointerRange<const char> getAuxMeta() override { return _it->second->getAuxMeta(); }
        ...
        bool isNullValue() const override
        {
            // method unused, to be removed under child of SDB-5924
            SCIDB_ASSERT(false);
            return _it->second->getBufHandle().isNull();
        }
...
public:
    ...
    /**
     * @return iterator to the element following the last element in chunk map
     */
