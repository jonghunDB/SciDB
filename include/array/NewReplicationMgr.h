...
#ifndef NEW_REPLICATION_MANAGER_H_
#define NEW_REPLICATION_MANAGER_H_
...
namespace scidb
{
     ...
     */
    class NewReplicationManager : public Singleton<NewReplicationManager>
    {
    public:
        ...
        private:
            ...
            friend class NewReplicationManager;
            Item(const Item&);
    ...
    NewReplicationManager(const NewReplicationManager&);
    NewReplicationManager& operator=(const NewReplicationManager&);
    ...
    InjectedErrorListener _listenerInjectedErrorReplicaWait;
    InjectedErrorListener _listenerInjectedErrorReplicaSend;
};
}
#endif
