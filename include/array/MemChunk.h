...
namespace scidb
{
    ...
    protected:
      ...
      public:
        ...
        void* getWriteData() override { dirty = true; return data; }
        void const* getConstData() const override{ return data; }
        ...
        void compress(CompressedBuffer& buf,
                      std::shared_ptr<ConstRLEEmptyBitmap>& emptyBitmap) const override;
        ...
        void showInfo(log4cxx::LoggerPtr const &logger, std::string const &prefix) const override
        {
#ifndef NDEBUG
            if( isInitialized() )
            {
