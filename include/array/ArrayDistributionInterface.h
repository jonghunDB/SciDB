 ...
 *   - Add to enum PartitioningSchema (right above psEND).
 ...
 *   -    Modify doesPartitioningSchemaHaveData().
 */
enum PartitioningSchema
{
    ...
    psReplication = psMIN,
    psHashPartitioned,
    psLocalInstance,    // all chunks on a single specified instance.  consider renaming
    psByRow,
    psByCol,
