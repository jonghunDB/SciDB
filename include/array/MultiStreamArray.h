#ifndef ___MULTISTREAMARRAY_H___
#define ___MULTISTREAMARRAY_H___
/*
**
* BEGIN_COPYRIGHT
*
...
class MultiStreamArray : public StreamArray
{
  public:
    ...
    public:
         ...
         *        e.g. the partial chunk may be "borrowed" and used as merged chunk
...
#endif // endif ___MULTISTREAMARRAY_H___
