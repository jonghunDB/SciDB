...
class PhysicalTestJoin: public PhysicalOperator
{
public:
    PhysicalTestJoin(const string& logicalName,
...
REGISTER_PHYSICAL_OPERATOR_FACTORY(PhysicalTestJoin, "test_join", "physical_test_join");
//DECLARE_PHYSICAL_OPERATOR_FACTORY(PhysicalTestJoin, "test_join", "physical_test_Join")
